            ...
            <main className="bg-blanc">
                ...
                <div className="w-auto h-28 border-black border-b-2">
                    <div className="flex">
                        ...
                        <div className="flex items-center">
                            <a href="/administration/articles" className="bg-beige hover:bg-beige text-white font-bold py-2 px-4 rounded flex items-center justify-center mr-72 border-4 border-white hover:brightness-50">Articles</a>
                        </div>
                    </div>
                </div>
            </main>

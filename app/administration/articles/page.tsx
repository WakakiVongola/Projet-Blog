                ...
                <div className="w-auto h-28 border-black border-b-2">
                    <div className="flex">
                        <div className="flex items-center">
                            <a href="/administration/utilisateurs" className="bg-beige hover:bg-beige text-white font-bold py-2 px-4 rounded flex items-center justify-center ml-64">Utilisateurs</a>
                        </div>
                        <div className="h-28 w-1 bg-black mx-auto"></div>
                        <div className="flex items-center">
                            <a href="/administration/articles" className="bg-beige hover:bg-beige text-white font-bold py-2 px-4 rounded flex items-center justify-center mr-72 border-4 border-white">Articles</a>
                        </div>
                    </div>
                </div>
            </body>
